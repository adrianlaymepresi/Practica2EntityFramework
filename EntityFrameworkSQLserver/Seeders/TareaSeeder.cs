...
namespace EntityFrameworkSQLserver.Seeders
{
    public class TareaSeeder : IDbInitializer
    {
        ...
        private void SeedTareaData(TareaDbContext context)
        {
            ...
            var tareaFaker = new Faker<Tarea>()
                ...
                .RuleFor(t => t.fechaVencimientoTarea, f => f.Date.Future(1))
                .RuleFor(t => t.estadoTarea, f => f.PickRandom(new[] { "Pendiente", "En Curso", "Finalizado", "Cancelado" }))
